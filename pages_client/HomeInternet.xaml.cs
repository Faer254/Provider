...
{
    public partial class HomeInternet : Page
    {
        private readonly ClientWindow clientWindow;

        public HomeInternet(ClientWindow window)
        {
            DataContext = new
            {
        ...
        private void loadServices()
        {
            ...
            clientService = Manager.dataBase.getClientHomeService((uint)Manager.user[0], 2);
            ...
            if (clientService.Any())
                dataTable = Manager.dataBase.getHomeServices(2, clientService[1].ToString());
            else
                dataTable = Manager.dataBase.getHomeServices(2);
