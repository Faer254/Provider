...
{
    public partial class LogEmployee : Page
    {
        private readonly EmployeeWindow _employeeWindow;
        public LogEmployee(EmployeeWindow window)
        {
            DataContext = new
            {
        ...
        private async Task loadTable()
        {
            ...
            await Task.Run(() =>
            {
                _dataTable = Manager.dataBase.getActionLog("employee_action");
            ...
            DataView employeeView = _dataTable.DefaultView.ToTable(true, "employee_id").DefaultView;

            DataTable dtWithEmpty = new DataTable();
            dtWithEmpty.Columns.Add("employee_id");

            dtWithEmpty.Rows.Add(new object[] { DBNull.Value });

            foreach (DataRowView row in employeeView)
            {
                dtWithEmpty.Rows.Add(row["employee_id"]);
            }

            employeeCB.ItemsSource = dtWithEmpty.DefaultView;
        ...
        private void ApplyCombinedFilter()
        {
            ...
            {
                employeeFilter = $"employee_id = {Convert.ToInt32(employeeCB.SelectedValue)}";
            }
        ...
        private void exportButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var saveFileDialog = new SaveFileDialog
            {
                ...
                FileName = $"Employee_log_{DateTime.Now:yyyyMMdd_HHmmss}.xlsx",
